...
public class FindCommand implements Command {
    ...
    private FindCommand( final long first, final long second ) {
        _first = first;
        _second = second;
    }
    
    public static FindCommand create( final long first, final long second ) {
        return new FindCommand( first, second );
    }
